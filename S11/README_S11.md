...
Number of parameters used: 11,173,962<br>
Training accuracy: 88.72<br>
Test accuracy: 88.24<br>

* In notebook we can visualize the gradcam results.
Please download the notebook here: ![Notebook](./S11.ipynb)
